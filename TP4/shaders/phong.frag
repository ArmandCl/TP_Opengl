...
{
    // ambient
    float ambientStrength = 0.1;  // TODO define ambient strength
    vec3 ambient = ambientStrength * lightColor;   // TODO calculate correct ambient color
    ...
    vec3 specular = specularStrength * spec * lightColor;   // TODO calculate correct specular color
